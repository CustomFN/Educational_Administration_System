				    ...
				    <table class="table table-bordered">
					        ...
					        <c:forEach items="${pageInfo.list }" var="course">
					        		 <tr>
										...
										<th>${course.courseweek }</th>
										<th>${course.coursetype }</th>
										<th>${course.score }</th>
										<th>
											<button class="btn btn-default btn-xs btn-info" onClick="location.href='/admin/editCourse?id=${course.courseid }'">修改</button>
											<button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='/admin/removeCourse?id=${course.courseid }'">删除</button>
										</th>
						            </tr>
					        	</c:forEach>
