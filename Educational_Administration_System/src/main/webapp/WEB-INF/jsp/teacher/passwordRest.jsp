				...
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
						<form name="reset" class="form-horizontal" role="form" action="/teacher/passwordRest" id="editfrom" method="post" onsubmit="return check()">
							  ...
							  <div class="form-group">
							    <label for="inputPassword32" class="col-sm-2 control-label">确认密码</label>
							    <div class="col-sm-10">
							      <input type="password" name="password2" class="form-control" id="inputPassword32" placeholder="请再次输入密码">
							    </div>
							  </div>
							  <div class="form-group" style="text-align: center">
								<span class="control-label" style="color: red;">${fail }</span>
							  	<span class="control-label" style="color: green;">${success }</span><br/>
