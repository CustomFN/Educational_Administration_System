 ...
 * Generated at: 2018-02-23 11:59:23 UTC
...
public final class userPasswordRest_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<form class=\"form-horizontal\" name=\"reset\" role=\"form\" action=\"/admin/userPasswordRest\" id=\"editfrom\" method=\"post\" onsubmit=\"return check()\">\n");
      out.write("\t\t\t\t\t\t\t  <div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t    <label for=\"inputEmail3\" class=\"col-sm-2 control-label\">账号(非管理员账号)</label>\n");
      out.write("\t\t\t\t\t\t\t    <div class=\"col-sm-10\">\n");
      out.write("\t\t\t\t\t\t\t      <input type=\"text\" class=\"form-control\" name=\"userid\" id=\"inputEmail3\" placeholder=\"请输入用户名\">\n");
      out.write("\t\t\t\t\t\t\t    </div>\n");
      out.write("\t\t\t\t\t\t\t  </div>\n");
      out.write("\t\t\t\t\t\t\t  <div class=\"form-group\">\n");
